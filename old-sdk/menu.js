...
// ================
{
        ...
        MenuStr += '<br>&nbsp;<br><table width=1000 border=0 cellpadding=0 cellspacing=0>';
      	MenuStr += '<tr><td height=40 width=1000 colspan=6><h1>Crashday Software Development Kit<font style="color:#BF2E11">_Documentation</font><img src="images/topline.jpg" align=right width=262 height=110></h1></td>';
      	MenuStr += '</tr>';
